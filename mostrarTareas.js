...
export function mostrarTodasTareas(aTareas) {
...
export function mostrarTareasPendientes(aTareas) {
...
export function mostrarTareasEnCurso(aTareas) {
...
export function mostrarTareasTerminadas(aTareas) {
