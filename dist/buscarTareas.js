...
export default function buscarTarea(tareas) {
    ...
    const resultados = []; // Define el tipo de resultados
    // Recorro el arreglo
    ...
    if (resultados.length > 0) {
        ...
        if (ver === "S") {
            let indice = leer("Ingrese el número de la tarea: "); // Asegúrate de que sea un string primero
            let indiceNumero = parseInt(indice) - 1; // Convierte a número aquí
