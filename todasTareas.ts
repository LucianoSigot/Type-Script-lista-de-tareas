...
function mostrarTareasPorEstado(arregloTarea: any[], estado: string, mensaje: string) {
...
export function mostrarTodasTareas(arregloTarea: any[]) {
    let opcionesMenu: string;
